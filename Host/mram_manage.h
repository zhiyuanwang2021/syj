...
#define     LOAD_TARE_VALUE_ADDR     (POSE_ENCODER_CODE_ADDR+4) //4Byte int32_t
#define     EXTEN_TARE_VALUE_ADDR    (LOAD_TARE_VALUE_ADDR+4) //4Byte int32_t
#define     EXTEN2_TARE_VALUE_ADDR     (EXTEN_TARE_VALUE_ADDR+4) //4Byte int32_t
#define     LOAD_TARE_CODE_ADDR    (EXTEN2_TARE_VALUE_ADDR+4) //4Byte int32_t
#define     EXTEN_TARE_CODE_ADDR     (LOAD_TARE_CODE_ADDR+4) //4Byte int32_t
#define     EXTEN2_TARE_CODE_ADDR    (EXTEN_TARE_CODE_ADDR+4) //4Byte int32_t
...
#define	PeInterface_ADDR		20000					   //��λ�����������??"xx.xx" 6*4
#define Application_ADDR 		(PeInterface_ADDR 	+ 6*4 )//��λ��Ӧ�ð汾��xxxxxxxx.xxx 13*4
#define Subsy_ADDR				(Application_ADDR 	+ 13*4)///��ϵͳ�汾��xx.xx 6*4
#define SubsyCustVer_ADDR		(Subsy_ADDR			+ 6*4 )//��ϵͳ�û��汾��xx.xx  6*4
#define SubsyCustName_ADDR		(SubsyCustVer_ADDR	+ 6*4 )//��ϵͳ�û�����xxxxxxxx 9*4
#define Bios_ADDR				(SubsyCustName_ADDR	+ 9*4 )//��λ��BIOS�汾��xx.xx 6*4
#define HwCtrl_ADDR				(Bios_ADDR			+ 6*4 )//��λ���������̼��š�xxxx.x 7*4
#define	PeInterfacePC_ADDR		(HwCtrl_ADDR		+ 7*4 )//PC����������汾��xx.xx 6*4
#define DpxVer_ADDR				(PeInterfacePC_ADDR + 6*4 )//DPX�ļ���ʽ�汾�š�xx.xx 6*4
#define	SerialNumber_ADDR		(DpxVer_ADDR		+ 6*4 )//��λ�����кš�xxxxxxxxxxxxxxxx  17*4
