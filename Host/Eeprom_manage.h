...
#define CHEAK_ADDR 32767	//???????????????????бь??????????
#define SENSOR_MAP_CHEAK_ADDR 32767	//???????????????????бь??????????

#define distance_scale_ADDR 	0//??????????????????бу?бш??бу?mm 4Byte distance_scale
...
//POS_MODE ??????иж????????бь????????бу 115Byte  400-522  иж????????иж??400-599
...
//LOAD_MODE ??????иж????????бь????????бу 115Byte  600-722  иж????????иж??600-799
...
//EXTEN_MODE ??????иж????????бь????????бу 115Byte  800-922  иж????????иж??800-999
...
#define Application_ADDR 		(PeInterface_ADDR 	+ 6*4 )//????????????????????бу?????????xxxxxxxx.xxx?????? 13*4
